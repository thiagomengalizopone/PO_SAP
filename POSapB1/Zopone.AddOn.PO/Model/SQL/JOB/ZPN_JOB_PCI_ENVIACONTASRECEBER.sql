...
-- 1. Criar o Job
EXEC sp_add_job 
    @job_name = N'ZPN_JOB_PCI_ENVIACONTASRECEBER - HMG';  -- Nome do Job
GO

-- 2. Adicionar uma etapa ao Job para executar a procedure
EXEC sp_add_jobstep
    @job_name = N'ZPN_JOB_PCI_ENVIACONTASRECEBER - HMG',
    @step_name = N'Executar a Procedure - ZPN_SP_PCI_ENVIACONTASRECEBER',
    @subsystem = N'TSQL',          -- Tipo de tarefa (Transact-SQL)
    @command = N'EXEC ZPN_SP_PCI_ENVIACONTASRECEBER 0;', -- Comando para executar a procedure
...
EXEC sp_add_schedule 
    @schedule_name = N'Agendamento a cada 60 segundos', -- Nome do agendamento
...
EXEC sp_attach_schedule 
    @job_name = N'ZPN_JOB_PCI_ENVIACONTASRECEBER - HMG',
    @schedule_name = N'Agendamento a cada 60 segundos';
GO
